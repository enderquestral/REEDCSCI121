...
def vig_break_for_length(cipher, klen, frequencies): #in the document, the vig is vigenere, but the outline we were given was just vig?
...
def sub_break(cipher, english_trigrams):
    ...
    # This takes way longer than Ideal
    ...
    while keeploop:
        ...
        holderval = randomkey2[placeholderint]
        holderval2 = randomkey2[placeholderint2]
        ...
        ##If the new step is BENEFIT, then go forward with it. If not, not.
